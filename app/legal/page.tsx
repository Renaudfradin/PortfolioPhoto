...
export default async function Legal() {
  ...
  return (
    <AnimationWrapper>
      <div className="min-h-screen text-[#09090b] dark:text-white">
        <div className="mx-auto max-w-3xl px-4 py-16">
          <div className="space-y-3">
            <h1 className="text-4xl font-bold">{t('title')}</h1>
            <p className="text-[#09090b] dark:text-zinc-400">{t('subtitle')}</p>
          </div>

          <div className="mt-10 space-y-10">
            <section className="space-y-3">
              <h2 className="text-2xl font-semibold">{t('title2')}</h2>
              <div className="text-[#09090b] dark:text-zinc-300 space-y-1">
                <p>
            ...
            <section className="space-y-3">
              ...
              <div className="text-[#09090b] dark:text-zinc-300 space-y-2">
                <p>{t('subtitle9')}</p>
                <p>{t('subtitle10')}</p>
              </div>
            </section>
